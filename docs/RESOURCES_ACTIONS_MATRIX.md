...
| contents:backgrounds_transistion                | resource_contents_backgrounds_transistion.yaml               |          |          |           |            |          | required |          |          |          |
| contents:backgrounds_transistion:item           | resource_contents_backgrounds_transistion_item.yaml          |          |          |           |            |          | required |          |          |          |
